...
<table width="100%" border="0">
	...
	<?php
		...
		$sql = "SELECT * FROM adds where id='$_REQUEST[id]'";
		//'$_REQUEST[id]'
		...
		<tr>
			...
			<td width="50%">
				...
				<div style="width: 100%; height: 500px; background-color: #d19792;">
					...
					Quantity <input type="number" name="qty" min="1" max="50" value="1" style="width: 50px;">
					<!--<input type="hidden" name="email" value="<?php echo $email ?>">-->
					<input type="hidden" onchange="setTwoNumberDecimal" min="0" max="99999" step="0.25" name="price" value="<?php echo $row["price"]; ?>">
					<input type="hidden" name="item" value="<?php echo $row["toy"]; ?>">
